...
def test_dense_backward_flatten():
    ...
    for x in NDArrayGenerator(4,2):
        ...
        w_grad_check = same(flatten2d_right(w_grad).asnumpy(), flatten2d_right(w_grad_e).asnumpy())
        w_grad_grad_check = same(flatten2d_right(w_grad_grad).asnumpy(), flatten2d_right(w_grad_grad_e).asnumpy())
        x_grad_check = same(flatten2d_right(x_grad).asnumpy(), flatten2d_right(x_grad_e).asnumpy())
        x_grad_grad_check = same(flatten2d_right(x_grad_grad).asnumpy(), flatten2d_right(x_grad_grad_e).asnumpy())
        ok_(x_grad_check)
        ok_(w_grad_check)
...
def test_dense_backward_no_flatten():
    ...
    for x in NDArrayGenerator(5,3):
        ...
        x_grad_e = nd.dot(o_y, w)
        x_grad_grad_e = nd.dot(o_y, o_w_grad)
        w_grad_check = same(flatten2d_left(w_grad).asnumpy(), flatten2d_left(w_grad_e).asnumpy())
        w_grad_grad_check = same(flatten2d_left(w_grad_grad).asnumpy(), flatten2d_left(w_grad_grad_e).asnumpy())
        x_grad_check = same(flatten2d_left(x_grad).asnumpy(), flatten2d_left(x_grad_e).asnumpy())
        x_grad_grad_check = same(flatten2d_left(x_grad_grad).asnumpy(), flatten2d_left(x_grad_grad_e).asnumpy())
        ok_(x_grad_check)
        ok_(w_grad_check)
        ok_(x_grad_grad_check)
        ok_(w_grad_grad_check)
